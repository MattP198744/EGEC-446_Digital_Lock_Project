...
#
# Script generated by Vivado on Sun Dec 14 22:54:33 -0800 2025
# SW Build 6140274 on Thu May 22 00:12:29 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : Digital_Lock_Diagram.sh
...
#
# Usage        : Digital_Lock_Diagram.sh
#                Digital_Lock_Diagram.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                Digital_Lock_Diagram.sh [-reset_run]
#                Digital_Lock_Diagram.sh [-reset_log]
#                Digital_Lock_Diagram.sh [-help]
#
...
# script info
echo -e "Digital_Lock_Diagram.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./Digital_Lock_Diagram.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot Digital_Lock_Diagram xil_defaultlib.Digital_Lock_Diagram xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim Digital_Lock_Diagram -key {Behavioral:sim_1:Functional:Digital_Lock_Diagram} -tclbatch cmd.tcl -protoinst "protoinst_files/Digital_Lock_Diagram.protoinst" -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb Digital_Lock_Diagram.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./Digital_Lock_Diagram.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: Digital_Lock_Diagram.sh [-help]\n\
Usage: Digital_Lock_Diagram.sh [-step]\n\
Usage: Digital_Lock_Diagram.sh [-lib_map_path]\n\
Usage: Digital_Lock_Diagram.sh [-reset_run]\n\
Usage: Digital_Lock_Diagram.sh [-reset_log]\n\
Usage: Digital_Lock_Diagram.sh [-keep_index]\n\
Usage: Digital_Lock_Diagram.sh [-noclean_files]\n\n\
